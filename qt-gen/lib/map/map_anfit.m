function MAP=map_anfit(ls,rho,H,n,ds,SA,SAlags)
...
if ~LSQFIT
    ...
    [f,r]=minimize(@objfun,@nnlcon,r0,100,1e-9);
...
warning off;
options = optimset('LargeScale','off','MaxIter',MAXITER, 'MaxFunEvals',1e10, 'MaxSQPIter',500, 'TolCon',TOL, 'Display','iter');
EPSTOL=100*TOL;
xlb=EPSTOL+0*x0;
